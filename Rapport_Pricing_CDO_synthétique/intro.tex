...
$(\Omega, \mathcal{F}, \mathbb{P}, (\mathcal{F}_t)_{t \geq 0})$ muni d'une probabilité risque-neutre $\mathbb{P}^*$ 
équivalente à $\mathbb{P}$. La filtration $\mathbb{F}:=(\mathcal{F}_t)_{t \geq 0}$ représente 
