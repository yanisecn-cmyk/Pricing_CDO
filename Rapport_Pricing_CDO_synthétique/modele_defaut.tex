...
\!\left[ \lambda(t) \exp\left(-\int_0^t \lambda(s) \, ds\right)\right].
\end{equation}
...
\begin{equation}
    \begin{split}
        \text{JF}(s) &
        = s\,N \sum_{k=1}^m \delta_k \; \mathbb{E}^{\mathbb{P}^\ast} \!\left[\frac{\mathbb{1}_{\{\tau > T_k\}}}{N_{T_k}}\right] \\
...
\begin{equation}
    \begin{split}
        \text{JV} &
        = N(1-R)\,\mathbb{E}^{\mathbb{P}^\ast} \!\left[\frac{\mathbb{1}_{\{\tau \le T\}}}{N_\tau}\right] \\
...
\end{equation}
où $N(t)$ est un processus de Poisson d'intensité $\lambda_J$ et les $Y_i$ sont des 
