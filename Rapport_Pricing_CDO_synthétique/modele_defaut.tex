...
\end{align*}
Finalement en posant $f(t, u) = \mathbb{P}(\tau > u \mid \mathcal{F}_t)$, nous obtenons l'équation
\begin{equation}
    1 - f(t,T) = \int_t^T \lambda_u \, f(t,u) \, du 
\end{equation}
Pouvant être dérivée pour obtenir le problème de Cauchy
\begin{equation}
    \begin{cases}
    ...
    \end{cases}
\end{equation}
Et la solution de ce problème est donnée par :
...
spread de marché équitable. Pour modéliser le temps de défaut, nous reprenons le résultat (\ref{eq:poisson_jump})
