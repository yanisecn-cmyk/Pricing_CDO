...
\begin{equation}\label{premium_leg}
    \text{JF}(s)
= s\,N
\sum_{k=1}^m 
\delta_k \; \mathbb{E}^{\mathbb{P}^\ast}
\!\left[\frac{\mathbf{1}_{\{\tau > T_k\}}}{N_{T_k}}\right].
\end{equation}
...
\begin{equation}\label{protection_leg}
    \text{JV}
    = N(1-R)\,
    \mathbb{E}^{\mathbb{P}^\ast}
    \!\left[\frac{\mathbf{1}_{\{\tau \le T\}}}{N_\tau}\right].
\end{equation}
...
(1-R)\;
\frac{
\mathbb{E}^{\mathbb{P}^\ast}\!\left[\frac{\mathbf{1}_{\{\tau \le T\}}}{N_\tau}\right]
}{
\sum_{k=1}^m 
\delta_k \, \mathbb{E}^{\mathbb{P}^\ast}\!\left[\frac{\mathbf{1}_{\{\tau > T_k\}}}{N_{T_k}}\right]
}.
\]
